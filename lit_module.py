"""
PyTorch Lightning Module for Cifar100 CNN
...
from config import scheduler_type, epochs, device
import copy
...
class Cifar100LightningModule(L.LightningModule):
    ...
    def __init__(
        ...
        # Initialize model
        self.model = torch.hub.load("pytorch/vision", "resnet18", weights=None)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log('test/f1_score', self.test_f1, on_step=False, on_epoch=True)
    ...
    def configure_optimizers(self):
        ...
        if scheduler_type == 'one_cycle_policy':
            ...
            # total_steps = 35200, epochs = 50 (from config)
            # So steps_per_epoch = 35200 / 50 = 704
            steps_per_epoch = 704  # 45000 / 64 = 703.125 -> round up to 704
            total_steps = epochs * steps_per_epoch  # 50 * 704 = 35200
    ...
    def on_train_start(self):
        ...
        try:
            ...
            try:
                ...
                arch_summary = summary(copy.deepcopy(self.model), input_size=(1, 3, 32, 32), verbose=0, device=self.device)
